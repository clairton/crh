...
ActiveRecord::Schema.define(:version => 20111012233254) do
  ...
  create_table "transaction_goods_items", :force => true do |t|
    ...
    t.decimal  "unit_price",                           :precision => 15, :scale => 6,                   :null => false
    t.decimal  "full_price",                           :precision => 15, :scale => 6,                   :null => false
    t.boolean  "active",                                                              :default => true, :null => false
    t.text     "remark"
    t.datetime "created_at"
    t.datetime "updated_at"
