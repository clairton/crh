class Email::User < ActiveRecord::Base
  has_one :participant_contact_email ,:class_name => "Participant::Contact::Email"
  ...
  validates_associated :participant_contact_email ,:class_name => "Participant::Contact::Email"
